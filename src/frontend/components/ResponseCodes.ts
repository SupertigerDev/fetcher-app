...
export const getResponseCodeDetails = (
  code: number
): (typeof ResponseCodes)[keyof typeof ResponseCodes] | undefined => {
  return ResponseCodes[code.toString() as keyof typeof ResponseCodes];
};
